def fetch_all_jobs(job,location):
    ...
    mail='princenoworkhere@gmail.com'
    passowrd='DataClinic'
...
data_scientist_jobs=pd.DataFrame(all_jobs)
data_scientist_jobs.to_csv(f'data_scientist_jobs_data_scraping.csv',index=False)